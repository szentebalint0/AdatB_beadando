...
```js
Cassandra 4.0.11-3a52ecb0d31d | CQL spec 3.4.5 | Native protocol v4 | TLS]
```
...
```js
SELECT type, release_year, COUNT(*) AS record_count
FROM movies_and_tv
...
INSERT INTO Szemely (nev, szulev, foglalkozas) VALUES ('Toth Otto', 1980, 'pincer');s
```
